...
public interface CommentService {
    ResponseDto<CommentsResponse.CommentResponse> createComment(@Positive(message = "taskId는 1 이상이어야합니당") Long taskId, CommentRequest.CommentCreateRequest dto);

    ResponseDto<List<CommentsResponse.CommentListResponse>> getAllComment();

    ResponseDto<List<CommentsResponse.CommentListResponse>> searchCommentByKeyword(String keyword);
